  ...
  s.fn.extend({
    smoothproducts: function () {
      ...
      s(".sp-loading").hide(),
            ...
            s(this).append(
              ...
              s("a", this).each(function (p) {
                var n = s("img", this).attr("src"),
                  i = s(this).attr("href"),
                  r = "";
                ((0 === p && !a) || s(this).hasClass("sp-default")) &&
                  ((r = ' class="sp-current"'),
                  (e = i),
                  (t = s("img", this)[0].src)),
                  s(this)
        ...
        s(document.body).on("mouseenter", ".sp-non-touch .sp-large", function (
          e
        ) {
          var t = s("a", this).attr("href");
          s(this).append('<div class="sp-zoom"><img src="' + t + '"/></div>'),
            s(this).find(".sp-zoom").fadeIn(250),
            e.preventDefault();
        }),
        s(document.body).on("mouseleave", ".sp-non-touch .sp-large", function (
          e
        ) {
          s(this)
            .find(".sp-zoom")
        ...
        s(document.body).on("click", "#sp-next", function (e) {
          ...
          if (a >= p);
            ...
            a == p - 1 && s("#sp-next").css("opacity", ".1"),
              ...
              s(".sp-selected .sp-thumbs a:eq(" + a + ")").addClass(
                "sp-current"
              ),
        ...
        s(document.body).on("click", "#sp-prev", function (e) {
          ...
          if (
            (e.stopPropagation(),
            0 >= (a = (a = s(".sp-lightbox").data("currenteq")) - 1))
          );
          else {
            ...
            s("#sp-next").css("opacity", "1"),
              s(".sp-selected .sp-current").removeClass(),
              s(".sp-selected .sp-thumbs a:eq(" + p + ")").addClass(
                "sp-current"
              ),
              s(".sp-selected .sp-large")
                .empty()
